...
@section('header')
<h2 class="h4 mb-0"><i class="bi bi-pencil-square me-2"></i>Editar Unidad</h2>
@endsection
...
<div class="row justify-content-center">
  <div class="col-lg-6">
    ...
    <div class="card">
      ...
      <div class="card-body">
        <form action="{{ route('admin.unidades.update', $unidad->id_unidad) }}" method="POST">
          @csrf
          @method('PUT')
          ...
          <div class="mb-3">
            ...
            <textarea class="form-control @error('descripcion') is-invalid @enderror" id="descripcion" name="descripcion" rows="3">{{ old('descripcion', $unidad->descripcion) }}</textarea>
          ...
          <div class="mb-3">
            <div class="form-check">
              <input type="checkbox" class="form-check-input" id="activo" name="activo" value="1" {{ old('activo', $unidad->activo) ? 'checked' : '' }}>
