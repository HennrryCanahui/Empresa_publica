...
@section('header')
<h2 class="h4 mb-0"><i class="bi bi-box-seam-fill me-2"></i>Crear Producto</h2>
@endsection
        ...
        <form action="{{ route('admin.productos.store') }}" method="POST">
          ...
          <div class="row">
            ...
            <div class="col-md-4 mb-3">
              ...
              <input type="text" class="form-control @error('unidad_medida') is-invalid @enderror" id="unidad_medida" name="unidad_medida" value="{{ old('unidad_medida') }}" placeholder="Ej: Unidad, Kg, Litro" required>
          ...
          <div class="row">
            <div class="col-md-6 mb-3">
              ...
              <div class="input-group">
                ...
                <input type="number" step="0.01" min="0" class="form-control" id="precio_referencia" name="precio_referencia" value="{{ old('precio_referencia') }}">
              </div>
            </div>
            <div class="col-md-6 mb-3">
          ...
          <div class="mb-3">
            ...
            <textarea class="form-control" id="especificaciones_tecnicas" name="especificaciones_tecnicas" rows="3">{{ old('especificaciones_tecnicas') }}</textarea>
          </div>
