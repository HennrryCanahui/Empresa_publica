...
@section('header')
<h2 class="h4 mb-0"><i class="bi bi-person-plus me-2"></i>Crear Nuevo Usuario</h2>
@endsection
      ...
      <div class="card-body">
        <form action="{{ route('admin.usuarios.store') }}" method="POST">
          ...
          <div class="row">
            ...
            <div class="col-md-6 mb-3">
              <label for="contrasena_confirmation" class="form-label">Confirmar Contraseña <span class="text-danger">*</span></label>
